...
// localstorage a array olarak gönderemiyoruz, onun yerine JSON a dönüştürmemiz lazım.
...
const makeItDone = (target) => {
  ...
  target.parentNode.childNodes[2].setAttribute("onclick", "removeDone(this)"); // burayı kontrol et
  target.className = "";
